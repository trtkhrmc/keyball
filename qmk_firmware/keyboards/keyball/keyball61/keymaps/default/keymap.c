...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [2] = LAYOUT_universal(
    ...
    _______  , KC_BSPC  , KC_7     , KC_8     , KC_9     , JP_SLSH   ,                                  KC_F12  , KC_BTN4  , KC_BTN3  , KC_BTN5  ,  KC_HOME, KC_PGUP   ,
    _______  , KC_LGUI  , KC_4     , KC_5     , KC_6     ,KC_MINS,                                     _______  , KC_BTN1  , KC_UP    , KC_BTN2  , KC_END  , KC_PGDN   ,
    _______  , KC_LALT  , KC_1     , KC_2     , KC_3     ,JP_PLUS , JP_ASTR   ,            _______   , _______  , KC_LEFT  , KC_DOWN  , KC_RGHT  , _______  , _______  ,
  ...
  [3] = LAYOUT_universal(
    ...
    _______  , CPI_I100  , CPI_D100  , CPI_I1K  , CPI_D1K  , _______  ,                                  KC_INS  , KC_BTN4  , KC_BTN3  , KC_BTN5 , XXXXXXX  , XXXXXXX  ,
