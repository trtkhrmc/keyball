...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [2] = LAYOUT_universal(
    ...
    KC_TAB   , KC_NUM_LOCK  , KC_P7     , KC_P8    , KC_P9   ,KC_KP_SLASH   ,                             KC_F12  , KC_BTN4  , _______  , KC_BTN5  ,  KC_HOME, KC_PGUP   ,
    KC_TAB   , KC_KP_DOT  , KC_P4     , KC_P5     , KC_P6   ,KC_KP_MINUS,                               _______  , KC_BTN1  , KC_UP    , KC_BTN2  , KC_END  , KC_PGDN   ,
    KC_LSFT  , KC_P0  , KC_P1     , KC_P2     , KC_P3   ,KC_KP_PLUS , KC_KP_ASTERISK,   _______   , _______  , KC_LEFT  , KC_DOWN  , KC_RGHT  , _______  , _______  ,
    KC_LCTL  , KC_LGUI  , KC_LALT , KC_LALT , _______ , _______  , _______  ,           KC_DEL  , _______  , _______  , _______  , _______  , _______  , _______
  ),
